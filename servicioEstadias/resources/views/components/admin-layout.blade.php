                ...
                <div class="ml-auto flex space-x-4">
                    ...
                    <div class="relative">
                        ...
                        <div id="dropdownMenu" class="absolute top-10 right-0 mt-2 bg-white border border-gray-300 rounded shadow-lg hidden">
                            ...
                            <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Histórico Convocatorias</a>
                            <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Registros de Usuarios</a>
                        </div>
                    </div>
